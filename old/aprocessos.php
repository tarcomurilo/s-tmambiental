...
<html>
	...
	<div id="boxfundo"></div>
		...
		<div id="secaocont2">
		<?php /* 
		<div id="bldtext" >Bem vindo ao atendimento ao cliente da TM Consultoria Ambiental<br><br></div>
		<div id="assinar-box1">
		...
		Se preferir não efetuar o cadastro de cliente agora, use o formulário da direita para nos enviar um e-mail.</div></div>
			...
			<table id="assinar-table3" style="float:clear; position:relative; top:0;float:left;">
			<tr>
			<form action="assinar.php" method="POST">
			<tr><td colspan="2"><div id="bldtext" align="center">Contato</div></td></tr>
			<td><div id="nmltext" >Nome: </div></td><td align="Center"><input maxlength="256" style="width:223px;" name="enome" type="text"></td>
			<tr><td><div id="nmltext" >E-mail: </div></td><td align="Center"><input maxlength="256" style="width:223px;" name="eemail" type="text"></td></tr>
			<tr><td><div id="nmltext" >Tel: </div></td><td align="Center"><input maxlength="32"style="width:223px;" name="etelefone" type="text"></td></tr>	
			<tr><td><div id="nmltext" >Assunto: </div></td><td align="Center"><input maxlength="256" style="width:223px;" name="eassunto" type="text"></td></tr>	
			<tr><td><div id="nmltext">Mensagem: </div></td><td align="Center"><textarea name="emensagem" rows="10" cols="29"></textarea></td></tr>				
			<tr><td colspan="2" align="right"><input type="Submit" value="Enviar" size="100" style="margin-right:12px"></td></tr>
			<tr><td colspan="2" align="right"><div id="bldtext2" style="float:right; margin:6px" ><?php echo $erromsg ?></div></td></tr><input type="hidden" name="wf" value="e">
			</form>
			</table>
				
	<img src="images/contato.png" style="border:2px solid; border-color:#00AA55; border-radius:5px;  margin-left:10px; position:relative; left:0px; float:right ">
		</div>
		<img id="figurasobre" src="images/landscape-banner.png" >
		</div>
		<div>
	</body>
